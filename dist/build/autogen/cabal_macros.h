...
/* package haskeroids-0.1.0.0 */
#define VERSION_haskeroids "0.1.0.0"
#define MIN_VERSION_haskeroids(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskeroids-0.1.0.0"

#define CURRENT_PACKAGE_KEY "haskeroids-0.1.0.0"
